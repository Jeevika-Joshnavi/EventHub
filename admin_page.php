...
<body>
    <header>
        <nav>
            ...
            <ul class="nav-links">
                ...
                <li><a href="#" class="active" onclick="scrollToTop()">Admin</a></li>
    ...
    <div class="main-content">
        <div class="center-boxes">
            <div class="admin-box" onclick="handleCreateEventClick()">
                <div class="admin-box-icon">➕</div>
                <a href="#">Create Event</a>
                <p class="admin-box-description">Add new events to the platform and manage event details</p>
            </div>
            
            <div class="admin-box" onclick="handleViewEventsClick()">
                <div class="admin-box-icon">📋</div>
                <a href="#">View Events</a>
                <p class="admin-box-description">Manage existing events, view registrations and analytics</p>
            </div>
        </div>
    </div>
    ...
    <footer>
        <div class="footer-content">
            <ul class="footer-links">
                ...
                <li><a href="user.php" onclick="scrollToTop()">User</a></li>
                <li><a href="admin.php" onclick="scrollToTop()">Admin</a></li>
            </ul>
    ...
    <script>
        ...
        function handleHomeClick() {
            window.location.href = 'mainpage.php.html';
        }
        ...
        function handleViewEventsClick() {
        ...
        document.addEventListener('DOMContentLoaded', function() {
            const boxes = document.querySelectorAll('.admin-box');
